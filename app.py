...
def main(address):
    ...
    user_question = st.text_input("Hi, how can I help you? (Try prompts like: We need help! There's a flood in my area || Language Supported: English, German, Spanish, Hindi, French and Arabic)", key="user_question")
