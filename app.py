...
st.image("https://logos-world.net/wp-content/uploads/2020/07/Accenture-Logo.png", width=75)
...
Use them to draft your response to help user in getting out of disaster. Show some numbers like how many teams are deployed and other metrics. Based on location (location: {address}) provide contact details of nearest relief center and government or NGOs contact details. Do not let user know about agents just provide well formatted answer. Remember always to tell user that you searched over web, social media and recent news and you were not able to find any latest disaster related information."""
                ),
